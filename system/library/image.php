...
class image
{
	...
	public function open($file)
	{
		...
		if(!file_exists($file))
		{
			dingoError("Image file not found: The image file ($file) could not be found.",E_USER_ERROR);
		}
	...
	public function type($type)
	{
		...
		{
			dingoError(E_USER_ERROR,"Invalid image type: The given image type ($type) was not valid.");
		}
		else
		{
	...
	public function zone_crop($width,$height,$zone='center')
	{
		...
		{
			dingoError(E_USER_ERROR,"Invalid image crop zone '$zone' given for image helper zone_crop().");
		}
